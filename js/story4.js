...
choices7.push(new Choice("Open a bug report with the R&D department.", 0, 19, 9999999));
...
choices8.push(new Choice("Ask about “displayOnSearch=1” on a slack channel", 0, 20, 9999999));
choices8.push(new Choice("Tell customer that displayOnSearch=1 returns no result in nonProd org", 0, 21, 99999));

choices9.push(new Choice("Ask about “displayOnSearch=1”on a slack channel", 0, 20, 9999999));
...
context.push(new Context("The customer mentions that is instance is indexing in a personal trial org. Your message got them check for the presence of this field in their content and they solved the issue on their end.", false, true));
