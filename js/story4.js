...
choices8.push(new Choice("Ask about “displayOnSearch=1” on a slack channel", 0, 20, 0));
choices8.push(new Choice("Tell customer that displayOnSearch=1 returns no result in nonProd org", 0, 21, 0));

choices9.push(new Choice("Ask about “displayOnSearch=1”on a slack channel", 0, 20, 0));
...
choices10.push(new Choice("Mention to the customer that trial orgs don’t come with free support and close the case.", 0, 22, 0));
choices10.push(new Choice("Check with the Client Success Manager to see if the customer can get free support", 0, 23, 0));
choices10.push(new Choice("Trigger a full rebuild on the trial org to see if there is any change on their site.", 0, 24, 0));
choices10.push(new Choice("Test the full query on the trial org mentioned by the customer.", 0, 25, 0));

choices11.push(new Choice("Mention to the customer that trial orgs don’t come with free support and close the case.", 0, 22, 0));
choices11.push(new Choice("Check with the Client Success Manager to see if the customer can get free support", 0, 23, 0));
choices11.push(new Choice("Trigger a full rebuild on the trial org to see if there is any change on their site.", 0, 24, 0));
...
context.push(new Context("The customer mentions that is instance is indexing in a personal trial org. Your message got them check for the presence of this field in their content and they solved the issue on their end. Somewhat okay outcome.", false, true));
