...
choices7.push(new Choice("Tell the customer that the issue hapened due to a Salesforce Maintenance. Provide the link to the known issue. Then tell him he needs to either resume the current operation or cancel it and start a new one.", 7, 22, 0, 4));
choices7.push(new Choice("Tell the customer that the issue hapened due to a Salesforce Maintenance. Provide the link to the known issue.  Then tell him that you've Canceled the current operation and started a Rebuild.", 7, 23, 10, 4));
choices7.push(new Choice("Tell the customer that the issue hapened due to a Salesforce Maintenance. Provide the link to the known issue. Then tell the customer to start a Rebuild.", 7, 24, 5, 4));
...
context.push(new Context("Someone in the customer organization had made changes to the case source and the new condition made it so that almost all content was deleted in Production.", false, false, 6));
