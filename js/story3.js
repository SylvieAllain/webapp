...
choices2.push(new Choice("Tell client the document is present, and you can see it, thus there is no issue", 0, 7, 9999));
choices2.push(new Choice("Ask the client why the document secured instead of public", 1, 2, 47));
choices2.push(new Choice("Ask what identity/email they have in their search", 2, 4, 0));
choices2.push(new Choice("Ask if the user should have access in Salesforce", 1, 2, 32));
...
choices3.push(new Choice("Anonymous users are not real users hence why you are not seeing the document", 0, 8, 9999));

choices4.push(new Choice("Send an email with the modifications to be done", 0, 9, 47));
choices4.push(new Choice("Go on meeting with customer and fix the filter with them", 0, 10, 0));
...
//context 3
context.push(new Context("The client gives you delegated access, you quickly find the issue in the filter and you are ready to make a recommendation to the customer.", false, false));
//ending
