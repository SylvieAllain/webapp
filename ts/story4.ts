...
var choices8: Choice[] = [];
var choices9: Choice[] = [];
var choices10: Choice[] = [];
var choices11: Choice[] = [];
var choices12: Choice[] = [];
...
choices1.push(new Choice("Is your search page accessible from outside your network?", 2, 4, 0, 0));
...
choices4.push(new Choice("Tell the customer that his query seems to be filtering results out", 9, 14, 0, 0));

choices5.push(new Choice("Suggest a meeting", 9, 11, 0, 2));
choices5.push(new Choice("What would be the full query that does not produce results ?", 9, 15, 2, 3));
